...
- **countries of the world** (their main landmass)
- **major Korean cities** (shown with their Latin and Korean names, e.g. *Busan (부산)*)
- the four **hand-drawn maps** from the original work (Seoul, Rome, Italy, South Korea)
...
4. **Maps.** Country and city silhouettes are generated from open geographic data
   (Natural Earth). For each country, only the main landmass is kept, so scattered outlying
   territories don't distort the frame.
